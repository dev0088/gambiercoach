  ...
  def login
    ...
    when :post
      ...
      if user != nil
        ...
        flash.now[:error] = "please re-check your login id and password<br/>If this is your first time using the service, scroll down and enter your Unix ID in the second box on this page"
        render
        return
      end
    end
